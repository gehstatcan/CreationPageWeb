...
LienQuestionnaire <- colDef(
  ...
  cell = function(value, index, column_name) {
    ...
    url2 <- paste0(lien_questionnaire,"match",calendrier[index, "NoQuestionnaire"],".htm")
     ...
     #3993/Saison22/SaisonReg/Questionnaires/match1.htm
     #3993/calendrier.html

     #BUT:
     #F:\Users\MM\Documents\Git\CreationPageWeb\Quarto\sitewebracine\Saison22\SaisonReg\Questionnaires
     #F:\Users\MM\Documents\Git\CreationPageWeb\Quarto\sitewebracine\Quarto\saison22\SaisonReg\calendrier.html
...
reactable(
  ...
  columns = list(
    ...
    "PointsA" =   colDef(name = "Pts",align = "center",maxWidth = 50),
    "PointsB" =   colDef(name = "Pts",align = "center",maxWidth = 50),
